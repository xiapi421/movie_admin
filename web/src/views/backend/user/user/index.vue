...
const baTable = new baTableClass(
    new baTableApi('/admin/user.User/'),
    {
        ...
        column: [
            ...
            { label: t('user.user.money'), prop: 'money', align: 'center', operator: 'RANGE', sortable: true },
            ...
            { label: '登录状态', prop: 'status', align: 'center', render: 'switch', operator: 'eq', sortable: false, replaceValue: { '0': t('user.user.status 0'), '1': t('user.user.status 1') } },
            ...
            { label: t('user.user.lastday_sell'), prop: 'lastday_sell', align: 'center', operator: 'RANGE', sortable: true, width: 160 },
            { label: t('user.user.today_sell'), prop: 'today_sell', align: 'center', operator: 'RANGE', sortable: true , width: 160},
            { label: t('user.user.lastday_money'), prop: 'lastday_money', align: 'center', operator: 'RANGE', sortable: true , width: 160},
